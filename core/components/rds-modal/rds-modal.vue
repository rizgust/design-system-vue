<template>
  ...
  >
    ...
    >
      <div
        class="rds-modal__before-content"
        ref="beforeContent"
        tabindex="0"
      ...
      <rds-button-set
        ...
        v-if="hasFooter"
      >
        <rds-button type="button" kind="secondary" @click="onOtherBtnClick" v-if="hasOtherBtn" ref="otherBtn">
          <slot name="other-button">Other button</slot>
        </rds-button>
        <rds-button type="button" kind="secondary" @click="onSecondaryClick" v-if="hasSecondary" ref="secondary">
      ...
      <div
        class="rds-modal__after-content"
        ref="afterContent"
        tabindex="0"
        style="position: absolute; height: 1px; width: 1px; left: -9999px;"
...
import RdsButtonSet from '../rds-button/rds-button-set.vue';
