<template>
  <div :class="`rds-pagination ${carbonPrefix}--pagination`" data-pagination>
    <div :class="`${carbonPrefix}--pagination__left`">
      ...
      >
        <rds-select-option
          ...
          >{{ size.label ? size.label : size.value ? size.value : size }}</rds-select-option
        >
      </rds-select>
...
export default {
  ...
  components: { RdsSelect, RdsSelectOption, CaretLeft16, CaretRight16 },
  props: {
