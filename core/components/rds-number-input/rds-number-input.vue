<template>
  <rds-wrapper :tag-type="formItem ? 'div' : ''" class="rds-number-input" :class="`${carbonPrefix}--form-item`">
    <div
      data-numberinput
      :class="[
        `${carbonPrefix}--number`,
...
export default {
  ...
  components: { Add16, Subtract16, WarningFilled16, RdsWrapper },
  inheritAttrs: false,
  props: {
    disabled: Boolean,
    ...
    invalid: /* deprecate */ {
      ...
      validator(val) {
        if (val !== undefined && process.env.NODE_ENV === 'development') {
          console.warn('RdsNumberInput: invalid prop deprecated in favour of invalidMessage');
        }
        return true;
      },
    },
