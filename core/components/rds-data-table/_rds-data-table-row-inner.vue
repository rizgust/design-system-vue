<template>
  <tr
    class="rds-data-table-row-inner"
  ...
  >
    ...
    <td v-if="hasOverflowMenu" :class="`${carbonPrefix}--table-column-menu`">
      <rds-overflow-menu v-bind="overflowMenuOptions">
        <rds-overflow-menu-item
...
import RdsOverflowMenu from '../rds-overflow-menu/rds-overflow-menu';
import RdsOverflowMenuItem from '../rds-overflow-menu/rds-overflow-menu-item';
import ChevronRight16 from '@carbon/icons-vue/es/chevron--right/16';
import { carbonPrefixMixin } from '../../mixins';

export default {
  name: 'RdsDataTableRowInner',
  mixins: [carbonPrefixMixin],
  components: { RdsCheckbox, RdsOverflowMenu, RdsOverflowMenuItem, ChevronRight16 },
  props: {
