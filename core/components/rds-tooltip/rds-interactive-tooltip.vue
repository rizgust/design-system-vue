<template>
  <div class="rds-interactive-tooltip">
    ...
    >
      <div
        class="rds-interactive-tooltip__before-content"
        ref="beforeContent"
        tabindex="0"
      ...
      <div
        class="rds-interactive-tooltip__after-content"
        ref="afterContent"
        tabindex="0"
        style="position: absolute; left: -9999px; width: 1px; height: 1px;"
  ...
  props: {
    ...
    direction: {
      ...
      validator(val) {
        ...
        if (!valid) {
          console.warn(`RDSInteractiveTooltip.direction must be one of the following: ${validValues}`);
        }
        return valid;
      },
    },
